...
<%
	ArrayList<Product> products= ao.getAllProducts();
...
<p style="color:pale-red;"> ${vo.category} | ${vo.preCategory} </p>
<br><br><br>
</div>

<div class="w3-col s3"><a href="delete.jsp?id=${i=i+1}"> <button class="w3-btn w3-pale-red w3-text-white"> 상품삭제</button></a></div>
...
<hr>
<a href="addProduct.jsp"> <button class="w3-btn w3-pale-red w3-text-white">상품등록</button></a>
 <br>
 <br>
 <br>
