...
<div class="w3-card-4">
  <div class="w3-container w3-pale-red w3-text-white">
    <h2>Pre-Market 상품 등록하기</h2>
  </div >
<form class="w3-container" action="processAddProduct.jsp" method="post" enctype="multipart/form-data">
   <p>
   ...
   <a href="preProductsList.jsp"><button class="w3-btn w3-pale-red w3-text-white" type="reset" value="등록 취소">등록 취소</button></a>
</form>
</div>
</body>
</html>